...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new io.rong.flutter.imlib.RongcloudImPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin rongcloud_im_plugin, io.rong.flutter.imlib.RongcloudImPlugin", e);
    }
    try {
